...
export function NavBar() {
  ...
  return (
    ...
    <nav 
      className={` flex  items-center w-full  bg-primary-100 transition-all duration-[0.5s] fixed ease-in-out py-6 px-3 z-[999]  ${scrolled ? ' bg-opacity-40 backdrop-blur-md' : ''}`}     //varia el scrolled aqui
    >
      ...
      <div className=' w-[80px] md:w-[100px] dark:text-white text-black'><GiPalmTree className='w-[100%] h-[100%]'/></div>
